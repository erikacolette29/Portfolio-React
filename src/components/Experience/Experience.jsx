...
const Experience = () => {
    ...
    <h1 className="heading" id="experience">My Experience</h1>
    <hr className="hr"/>
...
<div class="tab-content " id="pills-tabContent ">
  ...
  <p className="jobinfo"><span className="green">Illustrator</span> | LT Design | Austin, TX | 3.19-Present</p>
      <p className="jobinfo">Communicated with clients about visual requirements and brand strategy.</p>
      <p className="jobinfo">Created visual layouts and detailed graphic elements that align with client brief and business needs. </p>
      <p className="jobinfo">Collaborated with Principal and advisor to present strategies and designs to stakeholders. Promo-edit images, including portraits, logos, banners, buttons and animation elements.</p></div>

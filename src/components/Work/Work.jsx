...
const Work = () => {
    ...
    <div class="card  bg-transparent">
      <img src="/images/POCKETOLOGY.png" class="card-img-top proj-pic" alt="..." />
      <div class="card-body">
  ...
  <div class="col">
    <div class="card bg-transparent">
      <img src="/images/SnapOutOfIt.png" class="card-img-top proj-pic" alt="..." />
      <div class="card-body">
  ...
  <div class="col">
    <div class="card  bg-transparent">
      <img src="/images/SHIATSU.png" class="card-img-top proj-pic" alt="..." />
      <div class="card-body">
